    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('user-management') ? 'active' : '') }}" href="{{ url('user-management') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <img src="https://img.icons8.com/ios/20/null/conference-call--v1.png" />
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('categories') ? 'active' : '') }}"
            ...
            <div
                ...
                <img src="https://img.icons8.com/external-gradak-royyan-wijaya/20/null/external-categories-gradak-business-flad-gradak-royyan-wijaya.png"/>
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('admins') ? 'active' : '') }}" href="{{ url('admins') }}">
            <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <img src="https://img.icons8.com/ios-filled/20/null/administrator-male--v1.png" />
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('settings') ? 'active' : '') }}"
            ...
            <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <img src="https://img.icons8.com/ios/20/null/settings--v1.png" />
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('courses') ? 'active' : '') }}"
          ...
          <div
            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <img
                src="https://img.icons8.com/external-flaticons-lineal-flat-icons/20/000000/external-courses-resume-flaticons-lineal-flat-icons.png" />
          </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('posts') ? 'active' : '') }}"
          ...
          <div
            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <img src="https://img.icons8.com/fluency-systems-filled/20/null/choose-page.png" />
          </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('lawyers') ? 'active' : '') }}" href="{{ url('lawyers') }}">
            <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px"
                    height="12px"
